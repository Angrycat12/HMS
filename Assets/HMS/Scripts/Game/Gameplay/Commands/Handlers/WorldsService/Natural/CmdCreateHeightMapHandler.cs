...
public class CmdCreateHeightMapHandler: ICommandHandler<CmdCreateHeightMap>
{
    private readonly GameStateProxy _gameState;

    public CmdCreateHeightMapHandler(GameStateProxy gameState)
    {
        _gameState = gameState;
    }

    public bool Handle(CmdCreateHeightMap command)
    {
        ...
        _gameState.Worlds.FirstOrDefault(w => w.Origin.id == command.WorldId).HeightMap.OnNext(answer);
